...
import io.github.putrasattvika.jrmcremote.ui.main.MainActivity;
 ...
 * Time: 4:27 PM
 * Desc: PlayService
 * TODO: Change to mController
 */
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {

    private static final String ACTION_PLAY_TOGGLE = "io.github.sattvika.jrmcremote.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "io.github.sattvika.jrmcremote.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "io.github.sattvika.jrmcremote.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "io.github.sattvika.jrmcremote.ACTION.STOP_SERVICE";
    ...
    public void onCreate() {
        ...
        mPlayer = JRiverController.getInstance();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            if (ACTION_PLAY_TOGGLE.equals(action)) {
                ...
                RxBus.getInstance().post(new ExitAppEvent());
            }
        }
        return START_STICKY;
    }
